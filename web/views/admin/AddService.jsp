                ...
                <div class="form-group">
                    ...
                    <div class="input-box">
                        <select id="status" name="status" required>
                            ...
                            <option value="Active" ${sessionScope.formData.status == 'Active' ? 'selected' : ''}>Hoạt động</option>
                            <option value="Inactive" ${sessionScope.formData.status == 'Inactive' ? 'selected' : ''}>Không hoạt động</option>
                        </select>
